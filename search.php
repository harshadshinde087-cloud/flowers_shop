...
// Get search results
try {
    $stmt = $db->query("SELECT p.*, c.name as category_name FROM products p LEFT JOIN categories c ON p.category_id = c.id WHERE p.stock_quantity > 0 AND (p.name LIKE ? OR p.description LIKE ?) ORDER BY p.created_at DESC");
...
<body>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <form class="d-flex me-3" method="GET" action="search.php">
                                <input class="form-control me-2" type="search" name="q" placeholder="Search products..." style="border-radius: 20px; padding: 5px 15px;" value="<?php echo htmlspecialchars($query); ?>">
    ...
    <section class="py-4 bg-light">
        <div class="container">
            ...
            <p class="text-muted mb-0">Showing results for "<?php echo htmlspecialchars($query); ?>"</p>
        </div>
    </section>
    ...
    <section class="py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <p class="mb-0">Found <?php echo count($products); ?> products</p>
            ...
            <?php elseif (empty($products)): ?>
                <div class="text-center py-5">
                    ...
                    <div class="mt-3">
                        <form method="GET" action="search.php" class="d-inline-flex">
                            <input type="text" name="q" class="form-control me-2" placeholder="Search again..." value="<?php echo htmlspecialchars($query); ?>">
